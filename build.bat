...
copy cxche-guardian.service.template .\bin\linux
copy config.json.sample .\bin\linux\config.json
.\tools\7z.exe a -r -ttar .\bin\linux\guardian-linux64.tar .\bin\linux\guardian-linux64 .\bin\linux\config.json .\bin\linux\exclude.txt .\bin\linux\cxche-guardian.service.template .\bin\linux\html
